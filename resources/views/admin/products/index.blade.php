<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-bold text-2xl text-slate-800 leading-tight">📦 Product Management</h2>
    ...
    <script>
        ...
        function openAddModal() {
            ...
            document.getElementById('method_field').innerHTML = ''; // Clear PUT for new
        ...
        function openEditModal(product) {
            ...
            document.getElementsByName('is_active')[0].checked = product.is_active == 1;
